...
(conky -c 'scripts/dzen/conky_cal'; cal) | dzen2 -ta r -y 886 -w 150 -x 710 -l 7 -bg $BG -fg $FG -fn $FONT -e 'button2=;entertitle=exec cal,uncollapse,unhide;leaveslave=collapse;leavetitle=collapse' &
